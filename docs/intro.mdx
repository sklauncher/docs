...
## What is SKlauncher?
SKlauncher is a free game launcher to play **Minecraft: Java Edition**, designed to offer players an easy-to-use, very user-friendly interface for managing the game and installed modifications, along with a range of offline features.
...
<ul className="emoji-list">
    ...
    <li>
        <span>🔐</span> Features full security to Microsoft accounts
    </li> 
    <li>
        <span>🚀</span> Frequently updated to provide new features
    </li>
    <li>
        <span>📦</span> Supports easy installation and managing modifications \*
    </li>
    <li>
