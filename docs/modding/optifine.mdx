...
4. Right click on the newly created installation and click on **Open Installation Directory** from the context menu. <span className="text--note">Note: For linux users this may not work. Just open the .minecraft folder</span>
