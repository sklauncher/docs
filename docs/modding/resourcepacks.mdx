...
PS: If you modified your [game directory](/faq/launcher-related#how-does-game-directory-work), then you should look for `resourcepacks` folder in that location.
