...
This page is still a work in progress, and you are totally welcome to help complete this by [contributing](/contributing/docs.mdx)!
...
Shaders usually require powerful hardware to run smoothly, such as a powerful GPU and a decent CPU. Otherwise your game with run terribly with a low framerates 
...
as a seperate profile and a standalone [Fabric](/modding/fabric.mdx), [Quilt](/modding/quilt.mdx), and [NeoForge](/modding/neoforge.mdx) mod.
...
1. Weak hardware: Shaders are very resource intensive and usually need a good GPU to run smoothly. If you do have good hardware and you game 
