...
1. Start by downloading the correct shaders from Modrinth, Curseforge, or any trusted site.
    - IMPORTANT: Shaderpacks are usually downloaded as a ZIP archive (`.zip`). It is important that you do not extract it, otherwise the shaderpack will not work. On macOS, it may be downloaded a folder, and in that case, simply compress the folder.
