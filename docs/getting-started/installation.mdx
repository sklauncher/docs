...
## Installing through the Installer (Windows)
...
1. Select Start Menu Folder: [Back][Next][Cancel]\
This is optional, you have the option to choose a different path. This only changes the path of the shortcuts, not the actual launcher.\
2. Ready To Install [Back][Install][Cancel]\
Click on Install, unless you want to change your shorcut path, which in that case, click on [Back]\
3. Installing SKlauncher:\
On this screen you only have to wait for the install to finish, once it's done, you'll go to the last step.
4. Completing the SKlauncher 3.2 Setup Wizard: [Finish]\
Once you're here, just click on Finish.

## Java Requirements (For .jar, .app, .dmg, and portable .exe)
