...
2. Select the version of SKlauncher that is compatible with your operating system
    ...
    - If you are using Linux or macOS, download the DMG file
...
On Windows, you have 3 options; the Setup, Jar, and the Exe.\
The Windows setup is a new addition and is the recommended way to install the launcher. With the setup, 
no other installations are necessary. The setup downloads all the required files including the JRE and JavaFX for you. It is also [open source.](https://github.com/sklauncher/installer)\
...
On macOS, you also have 3 options; the DMG, Jar, and .app\
The DMG and the .app are mostly the same thing and both require Java to work. The DMG requires you to drag it into the Applications 
folder to work.\
