...
\- The refresh token when you remove ReLogin in the [Microsoft - Manage applications](https://account.live.com/consent/Manage) page.\
\- The access token when you change your Microsoft password in the [Microsoft - Change your password](https://account.live.com/password/Change) page.
