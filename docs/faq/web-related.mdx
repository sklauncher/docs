...
- Yes, just [make your SKlauncher account](/getting-started/register) and when it asks for a username you type the same username you had in *Other Launcher*.
  - It's also case-sensitive, so it must be the exact same: going from *TheExample* to *theexample* isn't the same thing.
...
1. You can [join the Discord server](https://skmedix.pl/discord) and use the appropriate channels to ask a question. Before you do:
   - Search if someone else asked the same question
   - Formulate your question clearly
   - Wait patiently for an answer

2. Search the internet for general Minecraft questions:
   - Check [Minecraft Forum](https://www.minecraftforum.net/) and [Minecraft Wiki](https://minecraft.wiki/)
   - Use [Google](https://www.google.com/) or [YouTube](https://www.youtube.com/) for tutorials and guides
