...
You cannot play Minecraft: Bedrock Edition on SKlauncher since it is a Minecraft: Java Edition launcher. But if you own Minecraft: Bedrock Edition on PC, you should be able to get Minecraft: Java Edition for free, which you can use on the launcher. Unfortunately, if you only own Minecraft: Bedrock Edition on console (XBOX, Playstation, etc.) or on mobile (iOS, Android) you'll have to buy the game seperately for PC. Refer to the [question below](https://docs.skmedix.pl/faq/launcher-related#where-can-i-buy-the-game) for info on where to buy the game.
