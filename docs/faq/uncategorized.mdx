...
Sending everything to **[mclo.gs](https://mclo.gs/)** and sending the link is recommended, because **it will censor information** such as the **access token** (a concern if you're using Microsoft login).
