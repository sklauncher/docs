...
If your Discord account uses the same email as your SKlauncher account, you could click *Login with Discord*. This would be only for the remote case that you even forgot your email (although you could go to your Discord account to check your email address).
