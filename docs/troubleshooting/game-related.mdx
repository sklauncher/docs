...
<Tabs groupId="account-type">
  ...
  <TabItem value="Microsoft" label="Microsoft accounts" default>

    - Check that there are no problems with the [Xbox Live service](https://support.xbox.com/en-US/xbox-live-status).
    - Follow the error message and restart the game and launcher (you may want to try logging out and in again).

  </TabItem>

  <TabItem value="Offline" label="Offline accounts">
