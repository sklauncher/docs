...
### Downloading
> **When you download the setup, .exe or .jar file, your browser may block it as "potentially unwanted".**
...
Already answered [here](/faq/launcher-related#is-sklauncher-open-source). Short answer, No.
